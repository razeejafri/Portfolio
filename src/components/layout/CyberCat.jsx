    ...
    >
      ...
      >
        ...
        {isRunning && (
          <>
            <motion.span
              className="absolute -bottom-1 left-2 w-1.5 h-1.5 rounded-full bg-amber-300 blur-[0.5px]"
              animate={{ opacity: [0, 1, 0], scale: [0.5, 1.4, 0.5] }}
              transition={{ duration: gallopDuration, repeat: Infinity }}
            />
            <motion.span
              className="absolute -bottom-1 right-2 w-1.5 h-1.5 rounded-full bg-orange-400 blur-[0.5px]"

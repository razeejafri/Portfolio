...
export default function ProjectMockup({ type, project }) {
  ...
  if (project?.image) {
    return (
      <div className="w-full h-full relative group/mockup overflow-hidden bg-[#070A14] flex items-center justify-center">
        ...
        <div className="absolute inset-0 bg-gradient-to-t from-[#060810]/75 via-transparent to-black/20 pointer-events-none" />

        {/* Floating Snapshot / Click to Preview Indicator */}
        <div className="absolute bottom-3 right-3 px-3 py-1 rounded-full bg-[#05070E]/90 backdrop-blur-md border border-white/15 text-[10px] font-mono text-cyan-300 opacity-80 group-hover/mockup:opacity-100 group-hover/mockup:border-cyan-500/50 group-hover/mockup:bg-blue-950/80 transition-all duration-300 flex items-center gap-1.5 shadow-xl pointer-events-none">
  ...
  if (type === 'convertrova' || project?.id === 'pdf-saas') {
    return (
      <div className="w-full h-full bg-[#0E1320] text-slate-200 flex flex-col font-sans select-none overflow-hidden">
        {/* Sub-header */}
        <div className="px-4 py-2 bg-[#141B2D] border-b border-white/10 flex items-center justify-between text-[11px]">
          <div className="flex items-center gap-2">
            <span className="w-5 h-5 rounded bg-blue-600 flex items-center justify-center font-bold text-white text-[10px]">C</span>
            <span className="font-bold text-white font-heading tracking-tight">ConvertRova</span>
            <span className="text-[9px] font-mono px-1.5 py-0.5 rounded bg-blue-500/20 text-blue-400">v2.1</span>
          </div>
        ...
        <div className="p-4 bg-gradient-to-r from-blue-950/60 via-indigo-950/40 to-slate-900 border-b border-white/5 flex flex-col items-center text-center">
        ...
        <div className="p-3.5 grid grid-cols-2 gap-2 bg-[#090D18]">
          <div className="p-2.5 rounded-lg bg-[#111728] border border-white/5 flex items-center gap-2.5 hover:border-blue-500/30 transition-all">
            ...
            <div className="overflow-hidden">
              ...
              <div className="text-[8px] text-slate-400 truncate">Wasm In-Memory</div>
            </div>
          </div>
          ...
          <div className="p-2.5 rounded-lg bg-[#111728] border border-white/5 flex items-center gap-2.5 hover:border-blue-500/30 transition-all">
            ...
            <div className="overflow-hidden">
              ...
              <div className="text-[8px] text-slate-400 truncate">Fast Batch Engine</div>
            </div>
          </div>
          ...
          <div className="p-2.5 rounded-lg bg-[#111728] border border-white/5 flex items-center gap-2.5 hover:border-blue-500/30 transition-all">
            ...
            <div className="overflow-hidden">
              ...
              <div className="text-[8px] text-slate-400 truncate">Tesseract OCR</div>
            </div>
          </div>

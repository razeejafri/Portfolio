    ...
    <>
      ...
      >
        ...
        <style>{`
          ...
          /* Sparkle / play dots pulse near yarn */
          ...
          @keyframes catStretchJump {
            ...
            50% {
              /* Joyful stretch and leap upward */
              transform: translateY(-20px) scale(0.94, 1.12);
            }
            75% {
              /* Soft arc apex */
            ...
            100% {
              /* Landing with subtle happy settle */
              transform: translateY(0) scale(1, 1);
            }
          }
          ...
          .cyan-sparkle-glow {
            filter: drop-shadow(0 0 6px #00d4ff) drop-shadow(0 0 10px rgba(0, 212, 255, 0.6));
          }

          .cat-glow-text {
            text-shadow: 0 0 14px rgba(0, 212, 255, 0.6), 0 0 28px rgba(0, 212, 255, 0.3);
          }
        `}</style>

        {/* Ambient Dark Navy Radial Glow */}
        <div
          className="absolute w-84 h-84 rounded-full blur-[110px] pointer-events-none transition-all duration-700 opacity-60"
          style={{
            background: 'radial-gradient(circle, rgba(0, 212, 255, 0.12) 0%, rgba(59, 130, 246, 0.05) 50%, transparent 75%)',
        ...
        <div className="relative z-10 flex flex-col items-center justify-center">
          ...
          >
            ...
            >
              <defs>
                {/* Cyan Glow Filter for Yarn Accents */}
              ...
              {/* 1. ANIMATED TAIL (Base of spine, curles smoothly side to side) */}
              ...
              <g id="cat-body">
                ...
                <path d="M 97 155 L 97 159" stroke="#FFFFFF" strokeWidth="2" strokeLinecap="round" />
                <path d="M 101 155 L 101 159" stroke="#FFFFFF" strokeWidth="2" strokeLinecap="round" />
              </g>
              ...
              <g id="cat-batting-paw" className="cat-paw-animated">
                ...
                <path d="M 136 142 L 138 145" stroke="#FFFFFF" strokeWidth="2" strokeLinecap="round" />
                <path d="M 139 140 L 142 142" stroke="#FFFFFF" strokeWidth="2" strokeLinecap="round" />
              </g>
              ...
              <g id="yarn-ball" className="yarn-animated">
                ...
                {/* Trailing loose yarn thread in soft glowing cyan */}
                <path
              ...
              {/* Batting Sparkle Dots near paw and yarn */}
              <g id="sparkle-dots" className="cyan-sparkle-glow">
                <circle cx="134" cy="138" r="1.6" fill="#00d4ff" className="sparkle-dot-1" />
                <circle cx="140" cy="132" r="1.8" fill="#FFFFFF" className="sparkle-dot-2" />
                <circle cx="148" cy="136" r="1.5" fill="#00d4ff" className="sparkle-dot-3" />
              </g>
              ...
              <g id="cat-head">
                ...
                <path d="M 78 46 L 73 31 L 88 40" stroke="#FFFFFF" strokeWidth="1.8" strokeLinecap="round" opacity="0.85" />
                ...
                <path d="M 112 40 L 127 31 L 122 46" stroke="#FFFFFF" strokeWidth="1.8" strokeLinecap="round" opacity="0.85" />
                ...
                {/* Whiskers (Left) */}
                <path d="M 76 72 L 52 69" stroke="#FFFFFF" strokeWidth="1.8" strokeLinecap="round" opacity="0.9" />
                <path d="M 76 76 L 50 78" stroke="#FFFFFF" strokeWidth="1.8" strokeLinecap="round" opacity="0.9" />
                <path d="M 76 80 L 54 86" stroke="#FFFFFF" strokeWidth="1.8" strokeLinecap="round" opacity="0.9" />

                {/* Whiskers (Right) */}
                <path d="M 124 72 L 148 69" stroke="#FFFFFF" strokeWidth="1.8" strokeLinecap="round" opacity="0.9" />
                <path d="M 124 76 L 150 78" stroke="#FFFFFF" strokeWidth="1.8" strokeLinecap="round" opacity="0.9" />
                <path d="M 124 80 L 146 86" stroke="#FFFFFF" strokeWidth="1.8" strokeLinecap="round" opacity="0.9" />
                ...
                <g id="cat-eyes" className="cat-eyes-animated">
                  ...
                  <path
                    ...
                    strokeLinecap="round"
                  />
                  <circle cx="89" cy="62" r="1.8" fill="#FFFFFF" />
                  ...
                  <path
                    ...
                    strokeLinecap="round"
                  />
                  <circle cx="111" cy="62" r="1.8" fill="#FFFFFF" />
                </g>
              </g>
            </svg>
          </div>

          {/* Clean minimal presentation without percentage numbers or progress bar */}
        </div>
      </div>
    </>
  );
